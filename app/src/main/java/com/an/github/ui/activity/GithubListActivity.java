...
public class GithubListActivity extends AppCompatActivity implements RecyclerLayoutClickListener {
    ...
    private void initialiseViewModel() {
        githubListViewModel = ViewModelProviders
                .of(this, (ViewModelProvider.Factory) viewModelFactory)
                .get(GithubListViewModel.class);
        githubListViewModel.getRepositoryListLiveData().observe((LifecycleOwner) this, repositories -> {
